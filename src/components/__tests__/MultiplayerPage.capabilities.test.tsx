...
const base = {
  mode: 'host', setMode: vi.fn(), port: '25565', setPort: vi.fn(), roomCode: '', joinCode: '', setJoinCode: vi.fn(), mappedPort: null,
...
describe('MultiplayerPage capability surfaces', () => {
  ...
  it('shows room-code controls only for FriendTunnel', () => {
    ...
    expect(screen.getByText('multiplayer.room_code')).toBeTruthy();
  ...
  it('shows LAN discovery without room-code controls', () => {
    ...
    expect(screen.queryByText('multiplayer.room_code')).toBeNull();
  });
