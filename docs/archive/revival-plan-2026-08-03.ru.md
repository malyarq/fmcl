...
> **Исторический документ.** Этот аудит стал основой восстановительного релиза v0.7.0 и исправления v0.7.1. Он сохранён как запись решений и выполненной работы, а не как актуальная документация продукта. Оставшиеся задачи находятся в [текущем роадмапе](../ru/roadmap.md).
